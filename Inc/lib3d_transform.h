...
// l3d_err_t l3d_obj3d_rotateXGlobal(l3d_scene_t *scene, l3d_obj_type_t type, uint16_t idx, l3d_rtnl_t delta_angle_rad);
// l3d_err_t l3d_obj3d_rotateYGlobal(l3d_scene_t *scene, l3d_obj_type_t type, uint16_t idx, l3d_rtnl_t delta_angle_rad);
